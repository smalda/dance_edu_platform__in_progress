...
async def test_get_or_create_user(httpx_mock):
    ...
    httpx_mock.add_response(
        url="http://test/users/by_telegram_handle/test_user",
        status_code=404
    )
...
async def test_get_all_students(httpx_mock):
    ...
    httpx_mock.add_response(
        url="http://test/users/students/?offset=0&limit=100",
...
async def test_get_all_teachers(httpx_mock):
    ...
    httpx_mock.add_response(
        url="http://test/users/teachers/?offset=0&limit=100",
        json=expected_teachers
    )
...
async def test_get_submission_feedback(httpx_mock):
    ...
    httpx_mock.add_response(
        url="http://test/submissions/sub_1",
...
async def test_error_handling_404(httpx_mock):
    ...
    httpx_mock.add_callback(
        custom_response,
        url="http://test/users/by_telegram_id/nonexistent"
    )
